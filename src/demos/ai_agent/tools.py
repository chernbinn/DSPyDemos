import random
import string
from demos.ai_agent.data_model import Date, UserProfile, Flight, Itinerary, Ticket
from demos.ai_agent.dummy_data import flight_database, itinery_database, user_database, ticket_database
